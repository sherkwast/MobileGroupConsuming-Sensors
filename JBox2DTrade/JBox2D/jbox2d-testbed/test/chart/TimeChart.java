...
public class TimeChart {
	...
	private static DefaultCategoryDataset createDataset() throws IOException { // 这个数据集有点多，但都不难理解
		...
		int x1 = FileIO.getTwoAll("time/aggre_150_50_15", 10);
		int xx1 = FileIO.getTwoAll2("time/aggre_150_50_15", 10);
		int xxx1 = FileIO.getTwoAll3("time/aggre_150_50_15", 10);
		...
		int x2 = FileIO.getTwoAll("time/aggre_150_60_15", 10);
		int xx2 = FileIO.getTwoAll2("time/aggre_150_60_15", 10);
		int xxx2 = FileIO.getTwoAll3("time/aggre_150_60_15", 10);
		...
		int x3 = FileIO.getTwoAll("time/aggre_150_70_15", 10);
		int xx3 = FileIO.getTwoAll2("time/aggre_150_70_15", 10);
		int xxx3 = FileIO.getTwoAll3("time/aggre_150_70_15", 10);
		...
		int x4 = FileIO.getTwoAll("time/aggre_150_80_15", 10);
		int xx4 = FileIO.getTwoAll2("time/aggre_150_80_15", 10);
		int xxx4 = FileIO.getTwoAll3("time/aggre_150_80_15", 10);
		...
		int x5 = FileIO.getTwoAll("time/aggre_150_90_15", 10);
		int xx5 = FileIO.getTwoAll2("time/aggre_150_90_15", 10);
		int xxx5 = FileIO.getTwoAll3("time/aggre_150_90_15", 10);
		...
		int x6 = FileIO.getTwoAll("time/aggre_150_100_15", 10);
		int xx6 = FileIO.getTwoAll2("time/aggre_150_100_15", 10);
		int xxx6 = FileIO.getTwoAll3("time/aggre_150_100_15", 10);
		...
		int x7 = FileIO.getTwoAll("time/aggre_150_110_15", 10);
		int xx7 = FileIO.getTwoAll2("time/aggre_150_110_15", 10);
		int xxx7 = FileIO.getTwoAll3("time/aggre_150_110_15", 10);
